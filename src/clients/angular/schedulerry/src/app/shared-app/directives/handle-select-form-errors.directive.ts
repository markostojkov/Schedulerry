...
@Directive({
  selector: '[appHandleSelectFormErrors]'
})
export class HandleSelectFormErrorsDirective implements AfterViewInit {
  private errorComponent: ComponentRef<FormErrorComponent>;
  private control!: NgControl | null;
  @ContentChild(MatSelect, { read: ElementRef }) controlElementRef!: ElementRef;

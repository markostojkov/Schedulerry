...
namespace Schedulerry.Persistence.Migrations
{
    ...
    [Migration("20210802141751_reserve-prop")]
    partial class reserveprop
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Schedulerry.Persistence.Entities.Customer", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Schedulerry.Persistence.Entities.Reservation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
                    ...
                    b.Property<DateTime>("DateTimeOfReservation")
                        .HasColumnName("DateTimeOfReservation")
                        .HasColumnType("timestamp");

                    b.Property<DateTime>("DateTimeOfReservationEnding")
                        .HasColumnName("DateTimeOfReservationEnding")
                        .HasColumnType("timestamp");

                    b.Property<int>("ReservationLastsForMinutes")
                        .HasColumnName("ReservationLastsForMinutes")
                        .HasColumnType("int");
                    ...
                    b.Property<Guid>("ServiceOptionUid")
                        .HasColumnName("ServiceOptionUid")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Schedulerry.Persistence.Entities.Customer", b =>
                {
                    b.HasOne("Schedulerry.Persistence.Entities.ApplicationUser", "ApplicationUser")
                        .WithOne()
                        .HasForeignKey("Schedulerry.Persistence.Entities.Customer", "ApplicationUserFk")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Schedulerry.Persistence.Entities.Reservation", b =>
                {
                    b.HasOne("Schedulerry.Persistence.Entities.Customer", "Customer")
